...
const ftroli = {
  ...
  const jumlahUser = pendaftar.length
    ...
    const menulist = `
    70o0o0da BEH ${pushname} 👋.انا الجزار ${global.BotName}, بوت تم تطويري بواسطة: الجزار الوزير للانتقال باستخدام واتساب إلى المستوى التالي.
...
ارجوكم ان تدعموني قناتي انحذفت
*↲┃ ┃↱*

*سوي اشتراك ولايك وتعليق حلو مثلك🙄💞*
*✶━━━✲─ • ❨🤖❩ • ─✲━━━✶⌬*`)
    break
...
case 'help': case 'الاوامر': case 'menu': case 'اوامر': case 'القائمه': case 'جزار':{
    if (isBan) return reply(mess.banned)	 			
    if (isBanChat) return reply(mess.bangc)
...
↲انا ʙᴏТ  ᴇʟɢᴀᴢᴀʀ 🦇*, 
تم تطويري بواسطة *ᴇʟɢᴀᴢᴀʀ ᴀʟᴡᴀᴢᴇʀ❤️*.↲
...
*✶━━━✲─ • ❨🤖❩ • ─✲━━━✶
🪷شكرا لك على استخدام بوتات الجزار
🪷اذا اعجبك البوت سوي لايك واشترك في القناه
...
`
    ...
    {buttonId: `.بروفايل`, buttonText: {displayText: 'بروفايلي🤺'}, type: 1}
    ]
                let buttonMessage = {
...
const txt = ` الجزار بيحبك🌚❤️ / رقمي للتواصل معايا:https://api.whatsapp.com/send?phone=+201098906252    `
const mikuarray= [
